...
--extended-verification-key-file shelley.000.vkey \
--verification-key-file non.e.shelley.000.vkey
cardano-cli key non-extended-key \
--extended-verification-key-file shelley.001.vkey \
--verification-key-file non.e.shelley.001.vkey
```
