...
Now create a topology file for the pool and update the BFT nodes topologies so that they include the pool.  
...
Now write a script to start the stake pool node.  
